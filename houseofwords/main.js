...
let face = "Image of yourself that you let others see"; /*Between the quotation marks, 
...
let red = "Sun setting down over the sea"; //repeat the instructions with the word "red" (keep in the form of a noun)

let brain = "Human powered computer"; //repeat the instructions for the word "brain"

let masculine = "unafraid"; //define 'masculine' in ADJECCTIVE form, so 
//you could sub it into a sentence that uses the word as an ADJECTIVE

let think = "ponder"; //define 'think' in VERB form,
