...
function draw() {
  ...
  if (markerHiro.isVisible() == true) {
    ...
    triangle(hiroPosition.x+30, hiroPosition.y+75, hiroPosition.x+58, hiroPosition.y+20, hiroPosition.x+86, hiroPosition.y+75);
    fill('blue');
    triangle(hiroPosition.x+30, hiroPosition.y+75, hiroPosition.x+58, hiroPosition.y+50, hiroPosition.x+86, hiroPosition.y+75);
    strokeWeight(2);
    line(hiroPosition.x+58, hiroPosition.y+20, hiroPosition.x+58, hiroPosition.y+50);
